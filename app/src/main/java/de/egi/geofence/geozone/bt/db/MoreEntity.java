...
public class MoreEntity {
	...
	private Integer enter_btscan;
	private Integer exit_btscan;
	private Integer enter_btscan_on_timeout;
	private Integer exit_btscan_on_timeout;
	private Integer enter_btscan_off_timeout;
	private Integer exit_btscan_off_timeout;

	public Integer getEnter_btscan_off_timeout() {
		return enter_btscan_off_timeout;
	}
	...
	public void setEnter_btscan_off_timeout(Integer enter_btscan_off_timeout) {
		this.enter_btscan_off_timeout = enter_btscan_off_timeout;
	}

	public Integer getExit_btscan_off_timeout() {
		return exit_btscan_off_timeout;
	}

	public void setExit_btscan_off_timeout(Integer exit_btscan_off_timeout) {
		this.exit_btscan_off_timeout = exit_btscan_off_timeout;
	}

	public Integer getEnter_btscan_on_timeout() {
		return enter_btscan_on_timeout;
	}

	public void setEnter_btscan_on_timeout(Integer enter_btscan_on_timeout) {
		this.enter_btscan_on_timeout = enter_btscan_on_timeout;
	}

	public Integer getExit_btscan_on_timeout() {
		return exit_btscan_on_timeout;
	}

	public void setExit_btscan_on_timeout(Integer exit_btscan_on_timeout) {
		this.exit_btscan_on_timeout = exit_btscan_on_timeout;
	}
	...
	public Integer getEnter_btscan() {
		return enter_btscan;
	}

	public void setEnter_btscan(Integer enter_btscan) {
		this.enter_btscan = enter_btscan;
	}

	public Integer getExit_btscan() {
		return exit_btscan;
	}

	public void setExit_btscan(Integer exit_btscan) {
		this.exit_btscan = exit_btscan;
	}
}
