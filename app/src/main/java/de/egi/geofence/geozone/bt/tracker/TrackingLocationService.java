...
public class TrackingLocationService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener  {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
    	...
    	this.trackIntervall = Integer.parseInt((dbGlobalsHelper.getCursorGlobalsByKey(Constants.DB_KEY_LOCINTERVAL) == null) || (dbGlobalsHelper.getCursorGlobalsByKey(Constants.DB_KEY_LOCINTERVAL).equalsIgnoreCase("")) ? "5" : dbGlobalsHelper.getCursorGlobalsByKey(Constants.DB_KEY_LOCINTERVAL));
    	this.trackPrio = dbGlobalsHelper.getCursorGlobalsByKey(Constants.DB_KEY_LOCPRIORITY) == null ? LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY : Integer.parseInt(dbGlobalsHelper.getCursorGlobalsByKey(Constants.DB_KEY_LOCPRIORITY));
...
//				LatLng latLng = new LatLng(mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude());
			...
			alertDialogBuilder.setMessage(this.getString(de.egi.geofence.geozone.bt.R.string.alertPermissions));
			alertDialogBuilder.setTitle(this.getString(de.egi.geofence.geozone.bt.R.string.titleAlertPermissions));
