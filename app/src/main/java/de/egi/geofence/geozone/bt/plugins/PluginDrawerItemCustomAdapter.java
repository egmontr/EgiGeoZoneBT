...
package de.egi.geofence.geozone.bt.plugins;
...
class PluginDrawerItemCustomAdapter extends ArrayAdapter<PluginDrawerItem> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageViewIcon = (ImageView) listItem.findViewById(de.egi.geofence.geozone.bt.R.id.icon_plugin);
        TextView textViewName = (TextView) listItem.findViewById(de.egi.geofence.geozone.bt.R.id.text_plugin);
