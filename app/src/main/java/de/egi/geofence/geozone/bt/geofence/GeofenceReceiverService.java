...
public class GeofenceReceiverService extends IntentService {
    ...
    private void handleError(GeofencingEvent event){
        ...
        // Log the error
        Log.e(Constants.APPTAG, this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_error_detail, errorCode, errorMessage));
...
//                NotificationUtil.sendNotification(this, transitionType, ids, Constants.FROM_GOOGLE);
            ...
            Log.d(Constants.APPTAG, this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_notification_title, transitionType, ids));
            Log.d(Constants.APPTAG,	this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_notification_text));
            log.info("after handleGeofenceTransition: " + this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_notification_title, transitionType, ids));
            log.debug("after handleGeofenceTransition: " + this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_notification_text));
            // An invalid transition was reported
        } else {
            // Always log as an error
            Log.e(Constants.APPTAG, this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_invalid_type, transition, ""));
            log.error(this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_invalid_type, transition, ""));
        }
    }
    /**
    ...
    private String getTransitionString(int transitionType) {
        switch (transitionType) {
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                return this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_entered);

            case Geofence.GEOFENCE_TRANSITION_EXIT:
                return this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_exited);

            default:
                return this.getString(de.egi.geofence.geozone.bt.R.string.geofence_transition_unknown);
        }
    }
