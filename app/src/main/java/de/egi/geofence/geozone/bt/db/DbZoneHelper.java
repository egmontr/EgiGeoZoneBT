...
//        values.put(DbContract.ZoneEntry.CN_ACTIV, ZoneEntity.isActiv() ? 1 : 0);
        ...
        values.put(DbContract.ZoneEntry.CN_MODE, zoneEntity.isAutomatic() ? 1 : 0);
        values.put(DbContract.ZoneEntry.CN_ID_BEACON_ZONE, zoneEntity.getId_beacon());
        values.put(DbContract.ZoneEntry.CN_WIFI_INFO, zoneEntity.getWifi_info());
    ...
    private ZoneEntity cursorToZone(Cursor cursor) {
        ...
        zone.setAutomatic(cursor.getInt(21) == 1);
        zone.setId_beacon(cursor.getString(22));
        zone.setWifi_info(cursor.getString(23));
    ...
    public void updateZone(ZoneEntity zoneEntity) {
        ...
        values.put(DbContract.ZoneEntry.CN_BEACON, zoneEntity.getBeacon());
        values.put(DbContract.ZoneEntry.CN_ALIAS, zoneEntity.getAlias());
        values.put(DbContract.ZoneEntry.CN_MODE, zoneEntity.isAutomatic());
        values.put(DbContract.ZoneEntry.CN_ID_BEACON_ZONE, zoneEntity.getId_beacon());
        values.put(DbContract.ZoneEntry.CN_WIFI_INFO, zoneEntity.getWifi_info());
