...
public class DbMoreHelper{
    ...
    public void createMore(MoreEntity moreEntity) {
        ...
        values.put(DbContract.MoreEntry.CN_ENTER_BTSCAN, moreEntity.getEnter_btscan() == null ? 2 : moreEntity.getEnter_btscan());
        values.put(DbContract.MoreEntry.CN_EXIT_BTSCAN, moreEntity.getExit_btscan() == null ? 2 : moreEntity.getExit_btscan());
        values.put(DbContract.MoreEntry.CN_ENTER_BTSCAN_ON_TIMEOUT, moreEntity.getEnter_btscan_on_timeout() == null ? 0 : moreEntity.getEnter_btscan_on_timeout());
        values.put(DbContract.MoreEntry.CN_EXIT_BTSCAN_ON_TIMEOUT, moreEntity.getExit_btscan_on_timeout() == null ? 0 : moreEntity.getExit_btscan_on_timeout());
        values.put(DbContract.MoreEntry.CN_ENTER_BTSCAN_OFF_TIMEOUT, moreEntity.getEnter_btscan_off_timeout() == null ? 0 : moreEntity.getEnter_btscan_off_timeout());
        values.put(DbContract.MoreEntry.CN_EXIT_BTSCAN_OFF_TIMEOUT, moreEntity.getExit_btscan_off_timeout() == null ? 0 : moreEntity.getExit_btscan_off_timeout());
    ...
    private MoreEntity cursorToMore(Cursor cursor) {
        ...
        more.setEnter_btscan(cursor.getInt(10));
        more.setExit_btscan(cursor.getInt(11));
        more.setEnter_btscan_on_timeout(cursor.getInt(12));
        more.setEnter_btscan_off_timeout(cursor.getInt(13));
        more.setExit_btscan_on_timeout(cursor.getInt(14));
        more.setExit_btscan_off_timeout(cursor.getInt(15));
        more.setEnter_soundMM(cursor.getInt(16));
        more.setExit_soundMM(cursor.getInt(17));
