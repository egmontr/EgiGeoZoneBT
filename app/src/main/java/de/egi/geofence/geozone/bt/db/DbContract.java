...
public class DbContract {
	...
	public static final  int    DATABASE_VERSION   = 10120; // Letzte Version mit DB-Änderung mit 10 vorangestellt
	...
	public static abstract class MoreEntry implements BaseColumns {
		...
		public static final String CN_ENTER_BTSCAN = "enter_btscan";
		public static final String CN_ENTER_BTSCAN_ON_TIMEOUT = "enter_btscan_on_timeout";
		public static final String CN_ENTER_BTSCAN_OFF_TIMEOUT = "enter_btscan_off_timeout";
		...
		public static final String CN_EXIT_BTSCAN = "exit_btscan";
		public static final String CN_EXIT_BTSCAN_ON_TIMEOUT = "exit_btscan_on_timeout";
		public static final String CN_EXIT_BTSCAN_OFF_TIMEOUT = "exit_btscan_off_timeout";

		public static final String[] allColumns = { _ID, CN_NAME,
				CN_ENTER_TASK, CN_ENTER_WIFI, CN_ENTER_SOUND, CN_ENTER_BT,
				CN_EXIT_TASK, CN_EXIT_WIFI, CN_EXIT_SOUND, CN_EXIT_BT, CN_ENTER_BTSCAN, CN_EXIT_BTSCAN,
				CN_ENTER_BTSCAN_ON_TIMEOUT, CN_ENTER_BTSCAN_OFF_TIMEOUT, CN_EXIT_BTSCAN_ON_TIMEOUT, CN_EXIT_BTSCAN_OFF_TIMEOUT, CN_ENTER_SOUND_MM, CN_EXIT_SOUND_MM
		};

		public static final String ALTER_TABLE_ADD_ENTER_BTSCAN = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_ENTER_BTSCAN + INTEGER_TYPE + " DEFAULT 3";

		public static final String ALTER_TABLE_ADD_ENTER_BTSCAN_ON_TIMEOUT = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_ENTER_BTSCAN_ON_TIMEOUT + INTEGER_TYPE + " DEFAULT 0";

		public static final String ALTER_TABLE_ADD_ENTER_BTSCAN_OFF_TIMEOUT = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_ENTER_BTSCAN_OFF_TIMEOUT + INTEGER_TYPE + " DEFAULT 0";

		public static final String ALTER_TABLE_ADD_EXIT_BTSCAN = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_EXIT_BTSCAN + INTEGER_TYPE + " DEFAULT 3";

		public static final String ALTER_TABLE_ADD_EXIT_BTSCAN_ON_TIMEOUT = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_EXIT_BTSCAN_ON_TIMEOUT + INTEGER_TYPE + " DEFAULT 0";

		public static final String ALTER_TABLE_ADD_EXIT_BTSCAN_OFF_TIMEOUT = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_EXIT_BTSCAN_OFF_TIMEOUT + INTEGER_TYPE + " DEFAULT 0";
		...
		public static final String CREATE_TABLE = "CREATE TABLE " +
				...
				CN_ENTER_BTSCAN + INTEGER_TYPE + COMMA_SEP +
				CN_EXIT_BTSCAN + INTEGER_TYPE + COMMA_SEP +
				CN_ENTER_BTSCAN_ON_TIMEOUT + INTEGER_TYPE + " DEFAULT 0" + COMMA_SEP +
				CN_ENTER_BTSCAN_OFF_TIMEOUT + INTEGER_TYPE + " DEFAULT 0" + COMMA_SEP +
				CN_EXIT_BTSCAN_ON_TIMEOUT + INTEGER_TYPE + " DEFAULT 0" + COMMA_SEP +
				CN_EXIT_BTSCAN_OFF_TIMEOUT + INTEGER_TYPE + " DEFAULT 0" + COMMA_SEP +
	...
	public static abstract class ZoneEntry implements BaseColumns {
		...
		public static final String CN_MODE = "mode"; // Automatic = 1 or Manual = 0
		public static final String CN_ID_BEACON_ZONE = "id_beacon_zone";
		public static final String CN_WIFI_INFO = "wifi_info";
		...
		public static final String ALTER_TABLE_ADD_WIFI_INFO = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_WIFI_INFO + TEXT_TYPE;
		...
		public static final String ALTER_TABLE_ADD_MODE = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_MODE + INTEGER_TYPE + " DEFAULT 1";

		public static final String ALTER_TABLE_ADD_ID_BEACON_ZONE = "ALTER TABLE " +
				TN + " ADD COLUMN " + CN_ID_BEACON_ZONE + TEXT_TYPE;
		...
		public static final String[] allColumns = { _ID, CN_NAME,
				...
				CN_ENTER_TRACKER, CN_EXIT_TRACKER, CN_STATUS, CN_ACCURACY, CN_TYPE, CN_BEACON, CN_ALIAS, CN_MODE, CN_ID_BEACON_ZONE, CN_WIFI_INFO
		};
		...
		public static final String CREATE_TABLE = "CREATE TABLE " +
				...
				CN_MODE + INTEGER_TYPE + COMMA_SEP +
				CN_ID_BEACON_ZONE + TEXT_TYPE + COMMA_SEP +
				CN_WIFI_INFO + TEXT_TYPE + COMMA_SEP +
