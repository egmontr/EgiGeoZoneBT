...
public class MoreProfile extends AppCompatActivity implements OnCheckedChangeListener, TextWatcher{
	...
	private EditText moreBtScanEnterOnTimeout = null;
	private EditText moreBtScanExitOnTimeout = null;
	private EditText moreBtScanEnterOffTimeout = null;
	private EditText moreBtScanExitOffTimeout = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		moreBtScanEnterOnTimeout = ((EditText) this.findViewById(R.id.editBluetoothScanBOnAfter));
		moreBtScanEnterOffTimeout = ((EditText) this.findViewById(R.id.editBluetoothScanBOffAfter));
		moreBtScanExitOnTimeout = ((EditText) this.findViewById(R.id.editBluetoothScanVOnAfter));
		moreBtScanExitOffTimeout = ((EditText) this.findViewById(R.id.editBluetoothScanVOffAfter));
		...
		moreBtScanEnterOnTimeout.addTextChangedListener(this);
		moreBtScanEnterOffTimeout.addTextChangedListener(this);
		moreBtScanExitOnTimeout.addTextChangedListener(this);
		moreBtScanExitOffTimeout.addTextChangedListener(this);

		moreBtScanEnterOnTimeout.setSelection(moreBtScanEnterOnTimeout.getText().length());
		moreBtScanEnterOffTimeout.setSelection(moreBtScanEnterOffTimeout.getText().length());
		moreBtScanExitOnTimeout.setSelection(moreBtScanExitOnTimeout.getText().length());
		moreBtScanExitOffTimeout.setSelection(moreBtScanExitOffTimeout.getText().length());
		...
		((RadioGroup)findViewById(R.id.radioGroupBluetoothScanB)).setOnCheckedChangeListener(this);
		((RadioGroup)findViewById(R.id.radioGroupBluetoothV)).setOnCheckedChangeListener(this);
		((RadioGroup)findViewById(R.id.radioGroupBluetoothScanV)).setOnCheckedChangeListener(this);
        ...
        if (null != b){
			...
			((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanB)).check(R.id.radioButtonBluetoothScanBNone);
			((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanV)).check(R.id.radioButtonBluetoothScanVNone);
...
//			boolean _new = true;
        ...
        if (_update){	
			...
			((EditText) this.findViewById(R.id.editBluetoothScanBOnAfter)).setText(String.valueOf(me.getEnter_btscan_on_timeout()));
			((EditText) this.findViewById(R.id.editBluetoothScanBOffAfter)).setText(String.valueOf(me.getEnter_btscan_off_timeout()));
			((EditText) this.findViewById(R.id.editBluetoothScanVOnAfter)).setText(String.valueOf(me.getExit_btscan_on_timeout()));
			((EditText) this.findViewById(R.id.editBluetoothScanVOffAfter)).setText(String.valueOf(me.getExit_btscan_off_timeout()));
			...
			switch (me.getEnter_btscan()) {
				case 0: ((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanB)).check(R.id.radioButtonBluetoothScanBOff);
					break;
				case 1: ((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanB)).check(R.id.radioButtonBluetoothScanBOn);
					break;
				case 2: ((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanB)).check(R.id.radioButtonBluetoothScanBNone);
					break;
				default:
					break;
			}

			switch (me.getExit_btscan()) {
				case 0: ((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanV)).check(R.id.radioButtonBluetoothScanVOff);
					break;
				case 1: ((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanV)).check(R.id.radioButtonBluetoothScanVOn);
					break;
				case 2: ((RadioGroup) this.findViewById(R.id.radioGroupBluetoothScanV)).check(R.id.radioButtonBluetoothScanVNone);
					break;
				default:
					break;
			}
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
		...
		if (radioGroup.getId() == R.id.radioGroupBluetoothScanB){
			switch (checkedId) {
				case R.id.radioButtonBluetoothScanBOn:
					me.setEnter_btscan(1);
					break;
				case R.id.radioButtonBluetoothScanBOff:
					me.setEnter_btscan(0);
					break;
				case R.id.radioButtonBluetoothScanBNone:
					me.setEnter_btscan(2);
					break;
			}
		}
		if (radioGroup.getId() == R.id.radioGroupBluetoothScanV){
			switch (checkedId) {
				case R.id.radioButtonBluetoothScanVOn:
					me.setExit_btscan(1);
					break;
				case R.id.radioButtonBluetoothScanVOff:
					me.setExit_btscan(0);
					break;
				case R.id.radioButtonBluetoothScanVNone:
					me.setExit_btscan(2);
					break;
			}
		}
...
//                    return;
	...
	public void afterTextChanged(Editable s) {
		...
		}else if (moreBtScanEnterOnTimeout.getText().hashCode() == s.hashCode()){
			if (((EditText) this.findViewById(R.id.editBluetoothScanBOnAfter)).getText().toString().equals("")) return;
			me.setEnter_btscan_on_timeout(Integer.parseInt(((EditText) this.findViewById(R.id.editBluetoothScanBOnAfter)).getText().toString()));
		}else if (moreBtScanEnterOffTimeout.getText().hashCode() == s.hashCode()){
			if (((EditText) this.findViewById(R.id.editBluetoothScanBOffAfter)).getText().toString().equals("")) return;
			me.setEnter_btscan_off_timeout(Integer.parseInt(((EditText) this.findViewById(R.id.editBluetoothScanBOffAfter)).getText().toString()));
		}else if (moreBtScanExitOnTimeout.getText().hashCode() == s.hashCode()){
			if (((EditText) this.findViewById(R.id.editBluetoothScanVOnAfter)).getText().toString().equals("")) return;
			me.setExit_btscan_on_timeout(Integer.parseInt(((EditText) this.findViewById(R.id.editBluetoothScanVOnAfter)).getText().toString()));
		}else if (moreBtScanExitOffTimeout.getText().hashCode() == s.hashCode()){
			if (((EditText) this.findViewById(R.id.editBluetoothScanVOffAfter)).getText().toString().equals("")) return;
			me.setExit_btscan_off_timeout(Integer.parseInt(((EditText) this.findViewById(R.id.editBluetoothScanVOffAfter)).getText().toString()));
		}else{
