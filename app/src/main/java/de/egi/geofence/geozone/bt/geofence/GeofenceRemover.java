...
//    }
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.d(Constants.APPTAG, mContext.getString(de.egi.geofence.geozone.bt.R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.d(Constants.APPTAG, mContext.getString(de.egi.geofence.geozone.bt.R.string.disconnected));
...
//        log.debug("onResult");
        ...
        switch (status.getStatusCode()){
            case 1000:
                statusMessage = mContext.getString(de.egi.geofence.geozone.bt.R.string.geofence_not_available) + " (" + GeofenceStatusCodes.getStatusCodeString(1000) + ")";
                break;
            case 1001:
                statusMessage = mContext.getString(de.egi.geofence.geozone.bt.R.string.geofence_too_many_geofences) + " (" + GeofenceStatusCodes.getStatusCodeString(1001) + ")";
                break;
            case 1002:
                statusMessage = mContext.getString(de.egi.geofence.geozone.bt.R.string.geofence_too_many_pending_intents)  + " (" + GeofenceStatusCodes.getStatusCodeString(1002) + ")";
                break;
            default:
...
//                toastMessage = mContext.getString(R.string.remove_geofences_intent_success) + " StatusCode: " + status.getStatusCode() + " StatusMessage: " + (status.getStatusMessage() != null ? status.getStatusMessage() : "");
                toastMessage = mContext.getString(de.egi.geofence.geozone.bt.R.string.remove_geofences_intent_success) + " StatusCode: " + statusMessage;
...
//                toastMessage = mContext.getString(R.string.remove_geofences_intent_failure) + " StatusCode: " + status.getStatusCode() + " StatusMessage: " + (status.getStatusMessage() != null ? status.getStatusMessage() : "");
                toastMessage = mContext.getString(de.egi.geofence.geozone.bt.R.string.remove_geofences_intent_failure) + " StatusCode: " + statusMessage;
                // Log an error
...
//                toastMessage = mContext.getString(R.string.remove_geofences_id_success) + " StatusCode: " + status.getStatusCode() + " StatusMessage: " + (status.getStatusMessage() != null ? status.getStatusMessage() : "");
                toastMessage = mContext.getString(de.egi.geofence.geozone.bt.R.string.remove_geofences_id_success) + " StatusCode: " + status.getStatusCode() + " StatusMessage: " + statusMessage;
                Log.d(Constants.APPTAG, toastMessage);
    		} else {
//                toastMessage = mContext.getString(R.string.remove_geofences_id_failure) + " StatusCode: " + status.getStatusCode() + " StatusMessage: " + (status.getStatusMessage() != null ? status.getStatusMessage() : "");
                toastMessage = mContext.getString(de.egi.geofence.geozone.bt.R.string.remove_geofences_id_failure) + " StatusCode: " + status.getStatusCode() + " StatusMessage: " + statusMessage;
                // Log an error
                Log.e(Constants.APPTAG, toastMessage);
