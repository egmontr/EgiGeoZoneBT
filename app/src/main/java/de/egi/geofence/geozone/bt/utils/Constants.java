...
public final class Constants {
    ...
    public static final String FROM_BEACON = "B";

    public static final int BEACON_MIN_BUILD = 18;
    ...
    public static final String DB_KEY_STOPTRACKINGATENTER = "stopTrackingAtEnter";
    public static final String DB_KEY_STOPTRACKINGATEXIT = "stopTrackingAtExit";


    public static final String DB_KEY_DEFAULT_FOREGROUND_SCAN_PERIOD = "defaultForegroundScanPeriod";
    public static final String DB_KEY_DEFAULT_FOREGROUND_BETWEEN_SCAN_PERIOD = "defaultForegroundBetweenScanPeriod";
    public static final String DB_KEY_DEFAULT_BACKGROUND_SCAN_PERIOD = "defaultBackgroundScanPeriod";
    public static final String DB_KEY_DEFAULT_BACKGROUND_BETWEEN_SCAN_PERIOD = "defaultBackgroundBetweenScanPeriod";
    ...
    // Intent actions
    public static final String ACTION_STATUS_CHANGED = "de.egi.geofence.geozone.bt.STATUS";
    ...
    public static final String ACTION_TEST_STATUS_OK =
            "de.egi.geofence.geozone.bt.TEST_STATUS_OK";

    public static final String ACTION_TEST_STATUS_NOK =
            "de.egi.geofence.geozone.bt.TEST_STATUS_NOK";

    public static final String ACTION_CONNECTION_ERROR =
            "de.egi.geofence.geozone.bt.ACTION_CONNECTION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
            "de.egi.geofence.geozone.bt.CATEGORY_LOCATION_SERVICES";

    // Keys for extended data in Intents
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "de.egi.geofence.geozone.bt.EXTRA_CONNECTION_ERROR_CODE";
    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX = "de.egi.geofence.geozone.bt.KEY";
    /*
