...
public class AuthenticationParameters {
    ...
    private String urlXHR = null;
    private String user = null;
    private String userPasswd = null;
    private boolean isGeofancyUrl = false;

    public String getUrlXHR() {
        return urlXHR;
    }

    public void setUrlXHR(String urlXHR) {
        this.urlXHR = urlXHR;
    }
    public boolean isGeofancyUrl() {
        return isGeofancyUrl;
    }

    public void setGeofancyUrl(boolean geofancyUrl) {
        isGeofancyUrl = geofancyUrl;
    }
