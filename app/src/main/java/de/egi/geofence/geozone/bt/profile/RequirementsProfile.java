...
public class RequirementsProfile extends AppCompatActivity implements OnItemSelectedListener, OnCheckedChangeListener, TextWatcher {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(de.egi.geofence.geozone.bt.R.layout.requirements_profile);
		...
		EditText prof_name = ((EditText) this.findViewById(de.egi.geofence.geozone.bt.R.id.value_name));
		prof_name.addTextChangedListener(this);

		spinner_enter = (Spinner)findViewById(de.egi.geofence.geozone.bt.R.id.spinner_enter);
		spinner_exit = (Spinner)findViewById(de.egi.geofence.geozone.bt.R.id.spinner_exit);
...
//			boolean _update = true;
		...
		((TextView) this.findViewById(de.egi.geofence.geozone.bt.R.id.value_name)).setText(re.getName());
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground( final Void ... params ) {
				...
				adapter = new ArrayAdapter<>(RequirementsProfile.this, de.egi.geofence.geozone.bt.R.layout.spinner_item, btDevs);
				adapter.setDropDownViewResource(de.egi.geofence.geozone.bt.R.layout.spinner_dropdown_item);
		...
		mo = ((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.mo));
		di = ((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.di));
		mi = ((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.mi));
		don = ((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.don));
		fr = ((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.fr));
		sa = ((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.sa));
		so = ((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.so));
		...
		((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.mo)).setChecked(re.isMon());
		((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.di)).setChecked(re.isTue());
		((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.mi)).setChecked(re.isWed());
		((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.don)).setChecked(re.isThu());
		((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.fr)).setChecked(re.isFri());
		((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.sa)).setChecked(re.isSat());
		((CheckBox) this.findViewById(de.egi.geofence.geozone.bt.R.id.so)).setChecked(re.isSun());
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (arg0.getId() == de.egi.geofence.geozone.bt.R.id.spinner_enter){
		...
		if (arg0.getId() == de.egi.geofence.geozone.bt.R.id.spinner_exit){
			Log.d("ConditionsOpt", "Selected item is: " + arg0.getSelectedItem());
	...
	public void afterTextChanged(Editable s) {
        re.setName(((EditText) this.findViewById(de.egi.geofence.geozone.bt.R.id.value_name)).getText().toString());
	}
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater inflater = getMenuInflater();
        inflater.inflate(de.egi.geofence.geozone.bt.R.menu.menu_profil_del, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case de.egi.geofence.geozone.bt.R.id.menu_delete_profile_log:
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            case DialogInterface.BUTTON_POSITIVE:
            	...
            	try{
	                ...
	                Toast.makeText(getApplicationContext(), de.egi.geofence.geozone.bt.R.string.profile_in_use, Toast.LENGTH_LONG).show();
	        	}
