...
public class GeofenceReceiver extends WakefulBroadcastReceiver  {
	...
	public void onReceive(Context context, Intent intent) {
		...
		// Explicitly specify that GeofenceReceiverService will handle the intent.
		ComponentName comp = new ComponentName(context.getPackageName(), GeofenceReceiverService.class.getName());
